...
import { INITIAL_FEATURE_001_STATE, type Feature001ScenarioState } from "@/lib/feature-001/scenario-state";
import {
  assessConflict,
...
/**
 * FEATURE-001-enhanced Reservation Detail. Everything on this surface beyond
 * the baseline cards (ConflictNotice, Test Controls, and the scenario/agent
 * state below) exists specifically because of FEATURE-001 — see
 * context/features/feature-001-predicted-conflict.md. Mounted only when the
 * activation boundary in reservation-detail-client.tsx enables it, so none
 * of this state initializes on the public default route.
 */
export function Feature001ReservationDetail() {
