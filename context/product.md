...
See also `context/features/feature-001-predicted-conflict.md`, `context/features/feature-002-damage-review.md`, and `context/features/feature-003-safety-intervention.md` for feature-scoped extraction of these same scenarios, and `context/data/evaluation-scenarios.json` for their structured form.
...
This list is intentionally explicit. AI analyzing Contera must not resolve these items by invention. See `context/data/policy-registry.json` for the structured form of this registry.
